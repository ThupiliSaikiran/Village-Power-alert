...
import { register, getVillages } from '../../services/api';
import {
  Container,
  Paper,
  TextField,
...
import { Person, Phone, Lock, LocationOn } from '@mui/icons-material';
        ...
        >
          <Box sx={{ textAlign: 'center', mb: 4 }}>
            ...
            <Typography variant="body1" color="textSecondary">
              Join Village Power Alert System
            </Typography>
          </Box>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <FormControl fullWidth margin="normal">
              ...
              >
                <MenuItem value="user">Villager</MenuItem>
